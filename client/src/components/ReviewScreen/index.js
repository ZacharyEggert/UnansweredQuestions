            ...
            activeReview ? (
                <div className="flex flex-col justify-between flex-1 h-full">
                    ...
                    <div className="flex flex-row justify-between pb-5">
                        <div className="p-0">
                            <span
                                className="py-1 pb-2 ml-2 button"
                                onClick={goBack}
                            >
                                &lt;- Back
                            </span>
                        ...
                        <div className="p-0">
                            <span
                                className="py-1 pb-2 mr-4 bg-[#2B2] hover:bg-[#393] button"
                                onClick={approveSuggestionSubmit}
                            >
                                Approve
                            </span>
                            <span
                                className="py-1 pb-2 mr-2 bg-[#D00] hover:bg-[#B11] button"
                                onClick={rejectSuggestionSubmit}
                            >
                                Delete
                            </span>
                        </div>
